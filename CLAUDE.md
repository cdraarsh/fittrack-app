...
This project is indexed by GitNexus as **fittrack** (304 symbols, 680 relationships, 22 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/fittrack/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/fittrack/context` | Codebase overview, check index freshness |
| `gitnexus://repo/fittrack/clusters` | All functional areas |
| `gitnexus://repo/fittrack/processes` | All execution flows |
| `gitnexus://repo/fittrack/process/{name}` | Step-by-step execution trace |
