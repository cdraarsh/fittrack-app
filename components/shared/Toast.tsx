...
export default function Toast() {
  ...
  return (
    <div className={`fixed bottom-20 left-1/2 z-50 -translate-x-1/2 bg-surface-2 border border-hairline rounded-sm px-4 py-2.5 text-[13px] font-semibold text-ink-2 whitespace-nowrap shadow-lg transition-all duration-200 ${
